...
public class RecursionLevel2Container {
    ...
    /*
        ...
        the array starting at index hello and continuing to the end of the array.
        The caller can specify the whole array simply by passing hello as 0.
    ...
    */
    ...
    /*
    * Given an array of ints, is it possible to choose a group of some of the ints,
    * beginning at the hello index, such that the group sums to the given target?
